...
$("#searchForm").on("submit", function (event) {
    ...
    var queryURL = 'https://cors-anywhere.herokuapp.com/https://app.ticketmaster.com/discovery/v2/events.json?apikey=LsnXngGMPvh119GAmqLkACcXZfGcJQ3g';

    var queryURL2 = "https://cors-anywhere.herokuapp.com/https://maps.googleapis.com/maps/api/place/textsearch/json?query=restaurants+in+" + location2 + "&key=AIzaSyDOfs17E2EBQGVcjAQQQO1-vtMh3BEULg8";
